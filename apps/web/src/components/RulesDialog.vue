...
const MODES = [
  ...
  { icon: '👁️', name: 'Chớp nhoáng', text: 'Đếm ngược 5 giây rồi cả bàn hé mở — bàn càng nhiều thẻ càng được nhìn lâu (50 thẻ được 15 giây). Nhớ được bao nhiêu thì ghép bấy nhiêu.' }
];
